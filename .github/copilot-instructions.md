...
Run `pwsh ./clean-up.ps1` after making code changes and before committing to ensure formatting compliance. The script processes the `alfreds-forge.slnx` solution.
...
- Full cleanup average (full solution): `607.558s`
