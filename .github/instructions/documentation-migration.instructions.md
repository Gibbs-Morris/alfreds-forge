...
Governing thought: Migration pages move readers from one exact Alfred's Forge version range to another with explicit compatibility, validation, and rollback guidance.
...
- This file **MUST** be applied only when the page is classified as `migration`. Why: Migration pages are versioned operational contracts.
...
Contributors and agents authoring migration pages for Alfred's Forge documentation.
