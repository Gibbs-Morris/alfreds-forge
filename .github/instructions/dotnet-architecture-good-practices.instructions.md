...
- Test strategy **MUST** follow testing instructions (PascalCase test names, L0-first, coverage >=80% overall/target 95-100% where feasible, 100% on touched code, Alfred's Forge mutation gate). Why: Ensures consistent verification.
