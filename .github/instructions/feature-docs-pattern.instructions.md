...
Governing thought: Alfred's Forge features that support both source-generated and manual registration paths need a subordinate documentation pattern, not a parallel taxonomy.
