...
# Mutation Testing Playbook (Alfred's Forge)
...
> Drift check: Open `eng/src/agent-scripts/mutation-test-Alfred's Forge-solution.ps1` and `summarize-mutation-survivors.ps1` before use; script outputs remain authoritative.
...
Mutation testing for Alfred's Forge solution projects (Samples are exempt).

## At-a-Glance Quick-Start

- Baseline run: `pwsh ./eng/src/agent-scripts/mutation-test-Alfred's Forge-solution.ps1`
