...
Developers adding or modifying DI registration in Alfred's Forge/Samples, including Orleans integrations.
...
For domain models using Alfred's Forge event sourcing:
