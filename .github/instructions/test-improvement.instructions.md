...
- Changed code paths **MUST** aim for 100% coverage with no regressions; Alfred's Forge mutation score **MUST** stay >=80%. Why: Protects quality while improving legacy areas.
...
- Mutation (Alfred's Forge): `pwsh ./eng/src/agent-scripts/test-project-quality.ps1 -TestProject <Name>`
